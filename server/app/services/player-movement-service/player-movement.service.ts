import { ANIMATION_INTERVAL, ITEM_TYPES, CHESTBOX_NAME } from '@app/constants/constants';
...
import { Game, GameData, Item, Player, Position, Tile, PlayerMovementParams } from '@common/interfaces';
